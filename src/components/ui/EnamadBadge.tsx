...
export default function EnamadBadge() {
    // Non-fixed badge for settings page
    return (
        <div
            className="flex items-center justify-center rounded-lg border border-gray-200 bg-white/90 p-2 shadow-lg backdrop-blur-sm dark:border-zinc-800 dark:bg-zinc-900/90"
