              ...
              {matches.map(match => (
                <div key={match.matchId} className="bg-white rounded-2xl p-4 shadow-md flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-[#1b73b5]">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-[#20b2f5] to-[#1b73b5] hover:from-[#1b73b5] hover:to-[#114b82] text-white px-5 py-2 rounded-xl font-bold shadow-[0_4px_0_#114b82] active:translate-y-1 active:shadow-none transition-all flex items-center gap-1 text-sm disabled:opacity-50"
                  >
